...
public class DiagonalRunner : IAgent<GridLayer>, IPositionable
{
    #region Init

    /// <summary>
    ///     The initialization method of the DiagonalRunner which is executed once at the beginning of a simulation.
    ...
    public void Init(GridLayer layer)
    {
        ...
        _layer.DiagonalRunnerEnvironment.Insert(this);
    }
    ...
    /// <summary>
    ///     The tick method of the DiagonalRunner which is executed during each time step of the simulation.
    ///     A DiagonalRunner can move randomly along diagonal lines. It must stay within the bounds of the GridLayer
    ...
    public void Tick()
    {
        ...
        if (0 <= newX && newX < _layer.Width && 0 <= newY && newY < _layer.Height)
        {
            ...
            if (_layer.IsRoutable(newX, newY))
            {
                ...
                _layer.DiagonalRunnerEnvironment.MoveTo(this, new Position(newX, newY));
